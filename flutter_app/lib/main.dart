...
final GoRouter _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/superadmin',   builder: (c, s) => const SuperAdminDashboardPage()), // kept for backwards compat
    GoRoute(path: '/admin/users',  builder: (c, s) => const SuperAdminDashboardPage()),
