...
class _SuperAdminDashboardPageState extends State<SuperAdminDashboardPage> {
        ...
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              ...
              title: Text('Edit User: ${user['name']}', style: theme.headlineSmall),
                ...
                child: Column(
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Email (Admin overwrite)'),
                    ),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: ['superadmin', 'admin', 'hr', 'manager', 'employee', 'client', 'pending']
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Super Admin Dashboard', style: theme.headlineSmall.copyWith(color: Colors.white)),
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    title: Text('${user['name']} (${user['role']})', style: theme.bodyLarge),
