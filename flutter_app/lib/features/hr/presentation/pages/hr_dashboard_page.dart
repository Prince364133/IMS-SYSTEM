...
class _HrDashboardPageState extends State<HrDashboardPage> {
        ...
        itemBuilder: (_, i) {
          ...
          return Container(
            ...
            child:
              ...
              Text(label,
                  style: t.labelMedium.copyWith(fontSize: 10),
  ...
  Widget _statCard(FlutterFlowTheme t, String label, String val, IconData icon,
          Color color) =>
      Expanded(
          child: Container(
        padding: const EdgeInsets.all(16),
  ...
  Widget _buildError(FlutterFlowTheme t) => Center(
          child: Column(
