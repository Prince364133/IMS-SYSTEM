    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _infoRow(
              theme, Icons.email_outlined, 'Email', _user?['email'] ?? '-'),
          _infoRow(
              theme, Icons.phone_outlined, 'Phone', _user?['phone'] ?? '-'),
          _infoRow(theme, Icons.business_outlined, 'Department',
              _user?['department'] ?? '-'),
          _infoRow(
              theme, Icons.work_outline, 'Position', _user?['position'] ?? '-'),
